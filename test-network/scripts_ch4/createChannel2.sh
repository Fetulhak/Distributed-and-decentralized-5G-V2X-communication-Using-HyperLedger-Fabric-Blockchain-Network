...
createChannelGenesisBlock() {
  setGlobals 1
	...
	if [ $bft_true -eq 1 ]; then
		...
		#configtxgen -profile ChannelUsingRaft1 -outputBlock ./channel-artifacts/${CHANNEL_NAME}.block -channelID $CHANNEL_NAME  
		configtxgen -profile ChannelUsingRaft2 -outputBlock ./channel-artifacts/${CHANNEL_NAME}.block -channelID $CHANNEL_NAME
		#configtxgen -profile ChannelUsingRaft3 -outputBlock ./channel-artifacts/${CHANNEL_NAME}.block -channelID $CHANNEL_NAME
		#configtxgen -profile ChannelUsingRaft4 -outputBlock ./channel-artifacts/${CHANNEL_NAME}.block -channelID $CHANNEL_NAME
	fi
	res=$?
	{ set +x; } 2>/dev/null
